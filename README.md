...
remotes::install_github(repo = "steverozen/mSigHdp", ref = "v2.0.2-branch", build_vignettes = TRUE)
```
...
<https://github.com/steverozen/mSigHdp/blob/v2.0.2-branch/mSigHdp_2.0.2.pdf>
