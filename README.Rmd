...
### Stable version
Download the [package source](https://github.com/steverozen/mSigHdp/blob/master/data-raw/source-file/mSigHdp_0.0.0.9022.tar.gz?raw=true) file to your computer and install mSigHdp locally:
